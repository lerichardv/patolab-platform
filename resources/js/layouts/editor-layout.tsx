...
function EditorLayoutContent({
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col bg-background overflow-x-hidden">
            ...
            {/* Top Header */}
            <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-xs flex h-16 shrink-0 items-center justify-between border-b border-border/50 px-6 transition-[width,height] ease-linear">
