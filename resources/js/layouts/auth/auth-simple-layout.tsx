    ...
    return (
        <div className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-background p-6 md:p-10">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                ...
                <div className="absolute right-[-10%] bottom-[-10%] h-[600px] w-[600px] rounded-full bg-indigo-600/20 blur-[120px]" />
            ...
            <div className="relative z-10 w-full max-w-sm">
                <div className="flex flex-col gap-6">
                    ...
                    <Card className="border-border/40 bg-background/60 shadow-xl backdrop-blur-xl">
