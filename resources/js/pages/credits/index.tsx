...
export default function CreditsIndex({
	...
	const [selectedCreditForView, setSelectedCreditForView] =
		useState<Credit | null>(null);
	const [creditToMarkAsPaid, setCreditToMarkAsPaid] =
		useState<Credit | null>(null);
		...
		<>
			...
			>
				<AlertDialogContent className="max-h-[90vh] w-full max-w-[580px] overflow-y-auto">
					...
					<form onSubmit={confirmMarkAsPaid} className="mt-2 flex flex-col gap-4">
						{/* Monto del crédito */}
						...
						<AlertDialogFooter className="pt-2">
							...
							>
								{isMarkingAsPaid && <Spinner className="mr-2" />}
								{isMarkingAsPaid
									? 'Guardando...'
