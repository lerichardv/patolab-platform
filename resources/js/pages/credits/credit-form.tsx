    ...
    const confirmSubmit = () => {
        ...
        post(payCredit(credit.id).url, {
            onSuccess: () => {
                toast.success(
                    data.is_social_security
                        ? 'Factura para seguro generada con éxito'
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Genera una factura para el Seguro sin registrar
                                ingreso ni abonar al saldo del crédito.
                            </p>
                        </div>
                        <Switch
            ...
            <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
                <AlertDialogContent className="max-w-[450px]">
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            {data.is_social_security
                                ? 'Confirmar Factura para Seguro'
                                : 'Confirmación de Abono'}
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            {data.is_social_security
                                ? 'Se generará la factura para el Seguro por el monto seleccionado. Este proceso no modificará el saldo del crédito.'
