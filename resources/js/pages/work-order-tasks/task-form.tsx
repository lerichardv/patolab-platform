...
export default function TaskForm({ task, onSuccess }: Props) {
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        duration_unit: task?.duration_unit || 'days',
        duration_value: task?.duration_value || 1,
        same_day_rule_enabled: task?.same_day_rule_enabled || false,
        same_day_cutoff_start: formatTime(task?.same_day_cutoff_start) || '',
        same_day_cutoff_end: formatTime(task?.same_day_cutoff_end) || '',
    });
                        ...
                        onCheckedChange={(checked) => {
                            setData((d) => ({
                                ...
                                same_day_cutoff_start: checked
                                    ? d.same_day_cutoff_start || '08:00'
                                    : '',
                                same_day_cutoff_end: checked
                                    ? d.same_day_cutoff_end || '17:00'
                                    : '',
                            }));
                        }}
                    />
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-dashed pt-2">
                        <div className="grid gap-2">
                            ...
                            <TimePicker
                                ...
                                onChange={(val) =>
                                    setData('same_day_cutoff_start', val)
                                }
                            />
                        ...
                        <div className="grid gap-2">
                            ...
                            <TimePicker
                                ...
                                onChange={(val) =>
                                    setData('same_day_cutoff_end', val)
                                }
                            />
