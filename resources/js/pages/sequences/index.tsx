...
export default function SequencesIndex({
    ...
    const canCreate = auth.permissions?.includes('sequences.create');
    const canEdit = auth.permissions?.includes('sequences.edit');
    const canDelete = auth.permissions?.includes('sequences.delete');
