        ...
        <form onSubmit={handlePreSubmit} className="space-y-6 px-5 py-2">
            ...
            {data.payment_type && data.payment_type !== 'credit' && (
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            setData('payment_method_date', e.target.value)
                        }
                        required
                    />
                    {errors.payment_method_date && (
                        <p className="text-xs text-destructive">
                            {errors.payment_method_date}
                        </p>
                    )}
                ...
                <div className="grid gap-4 rounded-lg border bg-muted/40 p-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('check_value', e.target.value)
                            }
                            placeholder="0.00"
                            className="font-mono"
                            required
                ...
                <div className="grid gap-4 rounded-lg border bg-muted/40 p-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('card_value_charged', e.target.value)
                            }
                            placeholder="0.00"
                            className="font-mono"
                            required
                ...
                <div className="grid gap-4 rounded-lg border bg-muted/40 p-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('transfer_value', e.target.value)
                            }
                            placeholder="0.00"
                            className="font-mono"
                            required
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="space-y-1">
                        ...
                        <p className="font-mono text-sm font-semibold">
                            L. {parseFloat(data.subtotal).toFixed(2)}
                        </p>
                    </div>
                    <div className="space-y-1">
                        <span className="text-xs text-muted-foreground">
                        ...
                        <p className="font-mono text-sm font-bold text-primary">
                            L. {parseFloat(data.total).toFixed(2)}
                        </p>
                    </div>
                </div>
                ...
                <div className="grid gap-2 rounded-lg border bg-muted/10 p-4">
                    ...
                    <div className="flex flex-col gap-2">
                        {invoice?.proof_of_payment &&
                            typeof invoice.proof_of_payment === 'string' && (
            ...
            <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
                <AlertDialogContent className="max-w-[450px]">
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            ¿Está seguro de actualizar los datos de la factura?
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            Esta acción guardará permanentemente los cambios en
                            la factura
                            {data.regenerate_pdf &&
                                ' y regenerará el archivo PDF de la factura correspondiente'}
                            .
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="my-4 flex items-center justify-between border-y py-3">
                        <div className="flex flex-col gap-0.5">
                            <Label
                                htmlFor="dialog_regenerate_pdf"
                                className="cursor-pointer font-semibold"
                            >
                                Regenerar archivo PDF de la factura
                            </Label>
                            <span className="text-xs text-muted-foreground">
                                Regenera el comprobante digital con los nuevos
                                datos.
                            </span>
                        </div>
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                setData('regenerate_pdf', checked)
                            }
                        />
                    </div>
                    <AlertDialogFooter>
