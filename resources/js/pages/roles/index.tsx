...
const permissionRows: PermissionRow[] = [
    ...
    {
        label: 'Resumen del laboratorio en el Dashboard',
        description:
            'Permite visualizar las tarjetas métricas de resumen, gráficos y muestras del día en la página de resumen.',
        module: 'Seguridad y Accesos',
        slugs: {
            view: 'dashboard.resume_cards.view',
        },
    },
    {
        label: 'Pacientes',
    ...
    {
        label: 'Control de Órdenes de Trabajo',
        description:
