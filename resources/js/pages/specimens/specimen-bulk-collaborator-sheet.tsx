...
export default function SpecimenBulkCollaboratorSheet({
        ...
        try {
            ...
            toast.success(
                response.data.message ||
                    'Colaborador asignado en lote correctamente',
            );
    ...
    const handleToggleCollaboratorAccess = async (
        ...
        setLocalSpecimens((prev) =>
            (prev ?? selectedSpecimens).map((specimen) => {
                ...
                return {
                    ...specimen,
                    collaborators: specimen.collaborators.map((c: any) =>
                        c.id === userId
                            ? {
                                  ...c,
                                  pivot: {
    ...
    const handleOpenChange = (newOpen: boolean) => {
        if (!newOpen && hasMutatedRef.current) {
            ...
            router.reload({
                only: ['assignments', 'priorities', 'specimens'],
            });
        }
                    ...
                    <div className="mt-4 flex h-full flex-col gap-6 px-5 pr-2 pb-8">
                        ...
                        <div className="flex min-h-0 flex-1 flex-col space-y-2.5">
                            <label className="text-sm font-semibold text-foreground">
                                Colaboradores Asignados (a una o más de las
                                muestras seleccionadas)
                            </label>
                                ...
                                {assignedCollaborators.length > 0 ? (
                                    ...
                                    <div className="flex h-full flex-col items-center justify-center space-y-2 px-4 py-12 text-center">
                                        ...
                                        <p className="max-w-xs text-xs text-muted-foreground">
                                            ...
                                            seleccionadas tiene colaboradores
