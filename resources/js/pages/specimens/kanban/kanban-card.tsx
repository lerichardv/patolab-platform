        ...
        >
            {(provided, snapshot) => (
                <div
                    ...
                    className={`relative flex cursor-pointer flex-col gap-2 rounded-md border p-3 shadow-sm transition-all duration-200 hover:border-primary/50 ${
                        snapshot.isDragging
                                ...
                                {auth.permissions?.includes(
                                    ...
                                    <>
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`absolute right-0 bottom-0 flex h-2.5 w-2.5 items-center justify-center rounded-full text-[7px] font-extrabold ring-1 ring-background ${
                                                    (specimen.users?.length ||
                                                        0) > 0
