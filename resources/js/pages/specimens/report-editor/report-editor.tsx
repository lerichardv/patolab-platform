					...
					<div className="h-[calc(100vh-64px)] w-screen overflow-auto lg:w-[50vw]">
						...
						<div className="flex flex-col gap-5 p-6">
							...
							<div className="relative rounded-xl border border-border/80 bg-card p-5 shadow-xs">
								...
								<div className="grid grid-cols-1 gap-4 text-xs md:grid-cols-2 mb-3">
								...
								<div className="flex flex-row flex-nowrap items-center justify-stretch w-full gap-5 pt-3">
