										...
										<div className="flex flex-col items-start gap-1.5 mt-3">
											...
											<div className="relative w-[200px]">
												<input
													...
													className="h-10 w-full rounded-md border border-input bg-card px-3 py-2 text-sm shadow-sm focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-60"
												/>
											</div>
										</div>
									</div>
									...
									<>
										{editorTemplateId && !isFinished && (
											<Button
												...
												className="flex h-9 items-center gap-2 bg-primary px-5 text-sm text-primary-foreground hover:bg-primary/95"
											>
												<Check className="h-4 w-4" />
												Aplicar
											</Button>
