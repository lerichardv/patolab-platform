    ...
    const calculateLayout = () => {
        ...
        for (let bIndex = 0; bIndex < blocks.length; bIndex++) {
            ...
            if (block.type === 'image-grid') {
                ...
                let remainingRows = [...rowsRemaining];
                ...
                while (remainingRows.length > 0) {
                    ...
                    const currentIndex = totalRows - remainingRows.length;

                    const minGridHeight = rowHeights[currentIndex] + 2.0;
                    ...
                    currentPage.push({
                        id: `${block.id}-slice-${remainingRows.length}`,
                        type: 'html',
                        html: sliceHtml,
                        height: cost,
                    });
                    ...
                    currentHeight += cost;
                    remainingRows = remainingRows.slice(r);
                }
                    ...
                    if (itemHeight > remaining) {
                        ...
                        if (itemsToFit.length > 0) {
                            ...
                            currentPage.push({
                                id: `${block.id}-items-${i}`,
                                type: 'html',
                                html: `<${tag} class="section-content"${startAttr}${listStyleAttr}${styleAttr}>${itemsToFit.join('')}</${tag}>`,
                                height: cost,
                            });
                            currentHeight += cost;
        ...
        fetch(
            ...
            .then((data) => {
                ...
                if (template.sections_order) {
                    setSectionsOrder(template.sections_order);
                }
