								...
								{templates && templates.length > 0 && (
									<div className="flex flex-col items-start gap-1.5 max-w-[calc(100%-110px)]">
										...
										<div className="w-full">
											...
											>
												<SelectTrigger className="h-10 w-full bg-card px-3 text-sm text-foreground w-full">
									...
									<>
										{editorTemplateId && !isFinished && (
											<Button
												...
												className="flex w-[110px] h-9 items-center gap-2 bg-primary px-5 text-sm text-primary-foreground hover:bg-primary/95"
											>
												<Check className="h-4 w-4" />
												Aplicar
											</Button>
