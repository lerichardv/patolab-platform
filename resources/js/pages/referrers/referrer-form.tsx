...
export default function ReferrerForm({ referrer, referrerTypes, onSuccess }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const options = {
            onSuccess: () => {
                toast.success(referrer ? 'Remitente actualizado' : 'Remitente creado');
                onSuccess();
            },
        };
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 py-4 px-5">
            ...
            <div className="grid gap-2">
                ...
                <Select value={data.referrer_type} onValueChange={(v) => setData('referrer_type', v)}>
                    <SelectTrigger>
                ...
                {errors.referrer_type && <p className="text-sm text-destructive">{errors.referrer_type}</p>}
            </div>
